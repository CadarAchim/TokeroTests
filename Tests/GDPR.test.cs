...
namespace TokeroTests.Tests
{
    public class GDPR
    {
        ...
        [InlineData("chromium")]
        [InlineData("firefox")]
        public async Task GdprPageLoadsCorrectly(string browserType)
        {
            ...
            await homePage.ClickGDPRLinkAsync();

            await page.WaitForLoadStateAsync(LoadState.DOMContentLoaded);

            Assert.True(await homePage.PageContainsTextAsync("GDPR"), $"{browserType}: GDPR page content was not found.");
